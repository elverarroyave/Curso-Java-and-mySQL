...
public class conexion extends javax.swing.JFrame {
    ...
    private void btnConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConectarActionPerformed
        ...
        try {
            ...
            // Para hacer transacciones a mysql debemos declarar algunas variables primero
            PreparedStatement ps;

            //Como no le vamos a colocar ningun were ponemos esta variable 
            ResultSet res;
            ...
            if (res.next()) {
                JOptionPane.showMessageDialog(null, "Nombre: " + res.getString("nombre") + ", Pedido:  " + res.getString("domicilio"));
            } else {
